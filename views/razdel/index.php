                                ...
                                <? foreach ($taskList as $task):?>
                                    <div id="panel<?echo $task['id'];?>" style="<?=$currTaskId!=$task['id']? 'display:none;' :''?>;" task-help-text='<?=htmlspecialchars($task["helpText"]);?>' task-solve-text='<?=htmlspecialchars($task["solveText"]);?>'  class="taskBody">
                                        <div class="col-sm-12 scoreBlock">
                                                <span id="score" is-solved="<? echo $task['zap_otvetov'] == false || $task['zap_otvetov']['is_true'] == 0 ?0:1;?>"><? echo $task['zap_otvetov'] == false || $task['zap_otvetov']['is_true'] == 0 ?'<span style="font-size: 15px; color: #843534">Тапсырма шешілмеген<span></span>':'<span id="popytki"><span style="color: #34b44a; font-size: 20px;">'.$task['zap_otvetov']['popytki'].'</span> талпыныстан шешілді   </span><span style="color: #34b44a;font-size: 20px;">'.$task['zap_otvetov']['score'].' </span><i class="fa fa-star" aria-hidden="true" style="color: gold;"></i>';?>
                                        </div>
                                        <div class="row">
<!--                                            <div class="col-sm-12">-->
